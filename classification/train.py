...
parser.add_argument('--model', default='ascn_cls', help='Model name [default: ascn_cls]')
...
def train():
    with tf.Graph().as_default():
        ...
        for epoch in range(MAX_EPOCH):
            ...
            test_accuracy = eval_one_epoch(sess, ops, test_writer)
            ...
            if test_accuracy > best_acc:
                ...
                best_epoch = epoch
        print('best accuracy is ', best_acc, ' epoch ', best_epoch)
